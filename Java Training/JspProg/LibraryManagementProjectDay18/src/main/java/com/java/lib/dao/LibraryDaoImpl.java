...
public class LibraryDaoImpl implements LibraryDao {
	...
	public TranBook getTransactionDetails(int bookId) throws ClassNotFoundException {
		 TranBook tranBook = null;
		 try {
		      Connection conn = ConnectionHelper.getConnection(); // Assumed database connection
		  ...
		  return tranBook;
		    ...
		    public void applyFine(String userName, int fineAmount) throws ClassNotFoundException {
		        try {
		            Connection conn = ConnectionHelper.getConnection(); // Assumed database connection
		    ...
		    public void updateBookReturn(TranBook tranBook) throws ClassNotFoundException {
		        try {
		            Connection conn = ConnectionHelper.getConnection(); // Assumed database connection

...
public class ProviderDaoImpl implements ProviderDao {
    ...
    public String addProvider(Provider provider) {
		System.out.println("IN DAO IMPL ADD START");
	    ...
	    trans.commit();
	    session.close();
		System.out.println("IN DAO IMPL END");
